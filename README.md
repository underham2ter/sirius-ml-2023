...
а) Скачать архив _, распаковать его в то же место что и ipybn, после чего запустить скрипт  с самого начала. Изображенич отелей скачаются автоматически.

б) Скачать архив _ с уже готовыми ихображениями, а также .csv, поместив их в одно место с ipybn. Тогда скрипт 
нужно запустить с части _.

Для демонстрации работы алгоритма я предлагаю выбрать 100 случайных отелей, а количество фотографий ограничить одной сотней, чтобы не затрачивать дополнительные вычислительные ресурсы. Предположим, что такого количества фотографий хватит для описания индивидуального отеля.
